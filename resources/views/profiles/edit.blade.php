...
<head>
    ...
    <title>Edit Setting Description | Wayang Riders</title>
    <!-- Boxicons -->
...
<body>
    ...
    <section id="content">
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/dashboard/setting_crud">Setting</a>
                        </li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                            <a class="active" href="#">Edit Setting</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container mt-5">
            <form action="{{ route('profiles.update', ['profiles' => $profiles->id]) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('community_structure') is-invalid @enderror" name="community_structure"
                        rows="5">{{ $profiles->community_structure }}</textarea>
                ...
                <div class="form-group">
                    <b><label class="font-weight-bold">Community Name</label></b>
                ...
                <div class="mb-3">
                    <b> <label for="video" class="form-label">Video</label> </b>
                ...
                <div class="mb-3">
                    <b> <label for="video" class="form-label">Video 1</label> </b>
                    <input type="file" name="video" class="form-control @error('video') is-invalid @enderror">
                    @error('video')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
                ...
                <div class="mb-3">
                    <b> <label for="video" class="form-label">Video 2</label> </b>
                    <input type="file" name="video" class="form-control @error('video') is-invalid @enderror">
                    @error('video')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
                ...
                <br>
                <div class="form-group">
                    <b> <label class="font-weight-bold">End Point</label> </b>
                    <textarea class="form-control @error('endpoint') is-invalid @enderror" name="endpoint" rows="5">{{ $profiles->endpoint }}</textarea>
                    @error('endpoint')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
                ...
                <div class="form-group">
                    <b> <label class="font-weight-bold">API Key</label> </b>
                    <textarea class="form-control @error('api_key') is-invalid @enderror" name="api_key" rows="5">{{ $profiles->api_key }}</textarea>
                    @error('api_key')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
