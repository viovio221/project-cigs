...
<head>
    ...
    <title>Qr Code | Wayang Riders</title>
    <!-- Boxicons -->
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="/dashboard/qrcode">Back to Dashboard</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <form action="{{ route('barcodes.store') }}" method="post" enctype="multipart/form-data">
                ...
                {{-- <div class="mb-3">
                 ...
                 --}}
                  <br>
                  {{-- <div class="mb-3">
                    <label for="barcode_path" class="form-label">Image</label>
                    <input type="file" name="barcode_path" class="form-control @error('barcode_path') is-invalid @enderror">
                    @error('barcode_path')
